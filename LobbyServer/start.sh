...
### example
### sh LobbyServer/start.sh node1 1
...
echo "NodeName = $NodeName, ServerKind = LobbyServer, ServerNo = $ServerNo"

### so we can distinguish different skynet processes
./skynet/skynet ./runconfig/config_lobby.lua $NodeName $ServerNo
